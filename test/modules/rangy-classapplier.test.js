define(["require", "exports", "../../lib/modules/rangy-classapplier", "../../lib/core"], function (require, exports, rangy_classapplier_1, rangy) {
    "use strict";
    exports.__esModule = true;
    QUnit.module("Class Applier module tests");
    QUnit.test('Editable tests', function (t) {
        t.ok(rangy_classapplier_1.ClassApplier.util);
        ...
        t.notOk(rangy_classapplier_1.util.isEditingHost(container));
        t.notOk(rangy_classapplier_1.util.isEditableElement(container));
        t.notOk(rangy_classapplier_1.util.isEditable(container));
        var nonEditableOuterText = container.firstChild;
        t.notOk(rangy_classapplier_1.util.isEditingHost(nonEditableOuterText));
        t.notOk(rangy_classapplier_1.util.isEditableElement(nonEditableOuterText));
        t.notOk(rangy_classapplier_1.util.isEditable(nonEditableOuterText));
        var editableDiv = nonEditableOuterText.nextSibling;
        t.ok(rangy_classapplier_1.util.isEditingHost(editableDiv));
        t.ok(rangy_classapplier_1.util.isEditableElement(editableDiv));
        t.notOk(rangy_classapplier_1.util.isEditable(editableDiv));
        var editableText = editableDiv.firstChild;
        t.notOk(rangy_classapplier_1.util.isEditingHost(editableText));
        t.notOk(rangy_classapplier_1.util.isEditableElement(editableText));
        t.ok(rangy_classapplier_1.util.isEditable(editableText));
        var nonEditableSpan = editableText.nextSibling;
        t.notOk(rangy_classapplier_1.util.isEditingHost(nonEditableSpan));
        t.notOk(rangy_classapplier_1.util.isEditableElement(nonEditableSpan));
        t.notOk(rangy_classapplier_1.util.isEditable(nonEditableSpan));
        var nonEditableText = nonEditableSpan.firstChild;
        t.notOk(rangy_classapplier_1.util.isEditingHost(nonEditableText));
        t.notOk(rangy_classapplier_1.util.isEditableElement(nonEditableText));
        t.notOk(rangy_classapplier_1.util.isEditable(nonEditableText));
    });
    QUnit.test("isAppliedToRange tests", function (t) {
        var applier = rangy_classapplier_1.createClassApplier("test");
    ...
    QUnit.test("toggleRange simple test 1", function (t) {
        var applier = rangy_classapplier_1.createClassApplier("test", true);
        var testEl = document.getElementById("qunit-fixture");
    ...
    var RangeInfo = /** @class */ (function () {
        function RangeInfo() {
        }
        RangeInfo.prototype.setStart = function (node, offset) {
            this.sc = node;
            this.so = offset;
        };
        RangeInfo.prototype.setEnd = function (node, offset) {
            this.ec = node;
            this.eo = offset;
        };
        return RangeInfo;
    ...
    QUnit.test("Test unapply to range spanning two blocks", function (t) {
        var applier = rangy_classapplier_1.createClassApplier("c1", true);
        var testEl = document.getElementById("qunit-fixture");
    ...
    */
    QUnit.test("Test issue 50 (Mac double click)", function (t) {
        var applier = rangy_classapplier_1.createClassApplier("c1");
        var testEl = document.getElementById("qunit-fixture");
    ...
    QUnit.test("Test issue 54 (two appliers, apply first then apply second to subrange then toggle first on same range)", function (t) {
        var applier1 = rangy_classapplier_1.createClassApplier("c1");
        var testEl = document.getElementById("qunit-fixture");
    ...
    QUnit.test("Test whitespace 3 (ignorable whitespace, ignore option disabled)", function (t) {
        var applier = rangy_classapplier_1.createClassApplier("c1", { ignoreWhiteSpace: false });
        var testEl = document.getElementById("qunit-fixture");
        var range = createRangeInHtml(testEl, 'x[<p>1</p> <p>2</p>]x');
        applier.applyToRange(range);
    ...
    QUnit.test("Test whitespace 4 (pre whitespace between paras)", function (t) {
        var applier = rangy_classapplier_1.createClassApplier("c1", { ignoreWhiteSpace: true });
        var testEl = document.getElementById("qunit-fixture");
    ...
    QUnit.test("Test adding extra class with overlapping containers", function (t) {
        var applier = rangy_classapplier_1.createClassApplier("c1", { elementProperties: { "className": "extra" } });
        var applier2 = rangy_classapplier_1.createClassApplier("c2", { elementProperties: { "className": "extra" } });
        var testEl = document.getElementById("qunit-fixture");
        var range = createRangeInHtml(testEl, 't[es]t');
        applier.applyToRange(range);
        applier2.applyToRange(range);
    ...
    QUnit.assert.notThrows = function (f, msg) {
        var e;
        try {
            f();
        }
        ...
        var desc = result || (typeof e.stack === 'undefined') ? '' : e.stack;
        this.pushResult({
            result: result,
            message: msg + desc
        });
    ...
    QUnit.test("Test issue 73 (range ending in element)", function (t) {
        ...
        t.notThrows(function () { return applier.toggleRange(range); });
    ...
    QUnit.test("Issue 111 (extra option for useExistingElements)", function (t) {
        ...
        applier = rangy_classapplier_1.createClassApplier("c1", {
    ...
    QUnit.skip("Merge error (issue 176)", function (t) {
        var applier = rangy_classapplier_1.createClassApplier("one");
        var testEl = document.getElementById("qunit-fixture");
